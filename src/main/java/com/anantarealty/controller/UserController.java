...
public class UserController {
    ...
    public boolean checkProfile() {
    	if (userRepository.findByemail(userDetailsService.getLoginUser()).getProfile().equals(Profile.ADMIN)) {
    		return true;
    	} else return false;
    ...
    public String getUserName() {
    	return (userRepository.findByemail(userDetailsService.getLoginUser())).getUsername();    
    	}
